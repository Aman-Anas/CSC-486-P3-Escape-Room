...
public partial class Farmer : RigidBody3D
{
    ...
    public void DisplayHeldStatue(string statueId, StandardMaterial3D? material)
    {
        ...
        GD.Print($"[DisplayHeldStatue] Starting display for {statueId}, material is {(material != null ? "provided" : "null")}");
        ...
        GD.Print($"[DisplayHeldStatue] Statue '{statueId}' added to hand display. Mesh visible: {heldStatueMesh.Visible}");
    }
